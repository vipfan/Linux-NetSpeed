...
sh_ver="1.2.1"
github="raw.githubusercontent.com/vipfan/Linux-NetSpeed/master"
...
startbbrmod_nanqinlang(){
	...
	if [[ "${release}" == "centos" ]]; then
		yum install -y make gcc
		mkdir bbrmod && cd bbrmod
		wget -N --no-check-certificate https://raw.githubusercontent.com/vipfan/Linux-NetSpeed/master/bbr/centos/tcp_nanqinlang.c
